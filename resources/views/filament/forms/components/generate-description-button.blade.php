<div class="flex justify-end mb-2">
    <button
        type="button"
        wire:click="$dispatch('generateDescription')"
    ...
    >
        ...
        <span wire:loading.remove wire:target="generateDescription">Generate from Hours</span>
        <span class="inline-flex items-center gap-2" wire:loading wire:target="generateDescription">
